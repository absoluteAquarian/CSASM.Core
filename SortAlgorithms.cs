...
namespace CSASM.Core{
	public static class SortAlgorithms{
		public static void TimSort<T>(T[] array) where T : struct, IComparable<T>{
		...
		private static void InsertionSort<T>(T[] array, int start, int end) where T : struct, IComparable<T>{
		...
		private static void Merge<T>(T[] array, int left, int mid, int right) where T : struct, IComparable<T>{
